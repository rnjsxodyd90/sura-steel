...
const PRODUCTS = [
  { 
    ...
    description: "\"Dal\" (달) means \"moon\" in Korean. Our signature set captures celestial beauty with a mirror polish finish that reflects light like moonlight on water. Hand-crafted for timeless elegance.",
    description_nl: "\"Dal\" (달) betekent \"maan\" in het Koreaans. Onze kenmerkende set vangt hemelse schoonheid met een spiegelglans afwerking die licht weerkaatst als maanlicht op water. Handgemaakt voor tijdloze elegantie.",
